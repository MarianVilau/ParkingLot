...
public class Cars extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse
        ...
        int occupiedParkingSpots = carsBean.countCars();
        int freeParkingSpots = totalParkingSpots - occupiedParkingSpots;
        request.setAttribute("numberOfFreeParkingSpots", freeParkingSpots);
        request.getRequestDispatcher("/WEB-INF/pages/cars/cars.jsp").forward(request,
                response);
    }
